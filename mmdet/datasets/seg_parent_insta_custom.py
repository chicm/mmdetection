...
VAL_IMG_DIR = '/home/chicm_dev/data/open-images/val'
...
def get_balanced_meta():
    ...
    selected_imgs = list(imgs_10_26) + shuffle(list(imgs_4_10))[:30000] + shuffle(list(imgs_0_4))[:35000] #[:1000]
...
class SegParentInstaCustomDataset(Dataset):
    """Custom dataset for detection.
